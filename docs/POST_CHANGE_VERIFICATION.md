...
- [ ] Add CLI integration test that runs `sveld` and snapshot-compares output.
- [ ] Consider Svelte 5 compiler as optional peer dep for full slots/events.
- [ ] Document `test/goldens` equivalent (fixtures + snapshots) in CONTRIBUTING.
